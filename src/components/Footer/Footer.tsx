      ...
      <div className='max-w-7xl container mx-auto'>
        <div className='grid grid-cols-1 gap-4 px-4 lg:grid-cols-3'>
          <div className='lg:col-span-1'>
            <div className="text-text-tt-ft">© 2022 Shopee. Tất cả các quyền được bảo lưu.</div>
          </div>
        ...
        <div className='mt-10 text-center px-4 text-sm'>
          ...
          <div className='mt-2 text-text-tt-ft'>© 2015 - Bản quyền thuộc về Công ty TNHH Shopee</div>
        </div>
      </div>
    </footer>
  )
