            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <ProductRating
                  ...
                  noneActiveClassName='h-4 w-4 fill-gray-300 text-gray-300'
                />
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='fomt-medium ml-3 text-3xl text-orange'>₫{formatCurrency(product.price)}</div>
              ...
              <div className='mt-8 flex items-center'>
                <button className='flex h-12 items-center justify-center rounded-sm border border-orange bg-orange/10 px-5 capitalize text-orange shadow-sm hover:bg-orange/50'>
                  <svg
