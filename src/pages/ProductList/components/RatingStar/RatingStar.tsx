...
interface Props {
  ...
  next: number
  handleLoadmoreRating: () => void
}

export default function RatingStars({ queryConfig, next, handleLoadmoreRating }: Props) {
  ...
  return (
    <ul className='my-3'>
      ...
      {next < Array(5).fill(0).length && (
        <button className='text-sm' onClick={handleLoadmoreRating}>
