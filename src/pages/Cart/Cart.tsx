  ...
  const totalCheckedPurchasePrice = useMemo(
    () =>
      checkedPurchases.reduce((res, cur) => {
        return res + cur.product.price * cur.buy_count
      }, 0),
    [checkedPurchases]
  )
  ...
  const totalCheckedPurchaseSavingPrice = useMemo(
    () =>
      checkedPurchases.reduce((res, cur) => {
        return (
          res +
          (cur.product.price_before_discount - cur.product.price) *
            cur.buy_count
        )
      }, 0),
    [checkedPurchases]
    ...
    <div className='bg-neutral-100 py-16'>
      <div className='container'>
        {extendedPurchases.length > 0 ? (
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
              ...
              <div className='mt-5 flex flex-col items-center sm:ml-auto sm:mt-0 sm:flex-row'>
                ...
                <Button
                  ...
                  className='mt-5 flex h-10 w-52 items-center justify-center bg-red-500 text-sm uppercase text-white hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-gray-800/90 sm:ml-4 sm:mt-0'
                >
                  Mua hàng
                </Button>
              </div>
          ...
          <div className='flex items-center justify-center'>
            <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2 text-center'>
              <img src={noproduct} alt='no purchase' className='h-48 w-48' />
              <p className='mt-3 font-semibold text-gray-400'>
                Giỏ hàng của bạn còn trống
              </p>
              <Link to={path.home}>
                <Button className='mt-3 rounded-sm bg-orange px-10 py-2 uppercase text-white'>
                  Mua ngay
                </Button>
              </Link>
            </div>
